 ...
 */
public class MovieUpcomingFragment extends SubpageFragment<MovieUpcomingPresenter> implements DoubanMovieUpcomingContract.View, MovieListAdapter.OnSwipeListener {
    @Bind(R.id.rv_movie)
